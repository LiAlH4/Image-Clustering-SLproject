...
class MNIST(Dataset):
    ...
    base_folder = 'mnist'
    train_list = [
        ['my_mnist_batch_0', 'c99cafc152244af753f735de768cd75f'],
        ['my_mnist_batch_1', 'c99cafc152244af753f735de768cd75f'],
        ['my_mnist_batch_2', 'd4bba439e000b95fd0a9bffe97cbabec'],
        ['my_mnist_batch_3', '54ebc095f3ab1f0389bbae665268c751'],
        ['my_mnist_batch_4', '634d18415352ddfa80567beed471001a'],
        ['my_mnist_batch_5', '482c414d41f54cd18b22e5b47cb7c3cb'],
    ]

    test_list = [
        ['my_mnist_test', '40351d587109b95175f43aff81a1287e'],
    ]
    meta = {
        'filename': 'my_mnist.meta',
        'key': 'label_names',
        'md5': '5ff9c542aee3614f3951f8cda6e48888',
    }

    def __init__(self, root=MyPath.db_root_dir('mnist'), train=True, transform=None, 
                    download=False):
